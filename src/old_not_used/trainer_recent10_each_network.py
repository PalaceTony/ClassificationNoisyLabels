...
class Trainer(object):
    ...
    def train_epoch(
        ...
        for batch_idx, (inputs_x, inputs_x2, labels_x, w_x, ids) in enumerate(
            ...
            if epoch < self.memory_bank_net1.q_length:
    ...
    def train(self):
        ...
        for epoch in (
            ...
            else range(start_epoch, self.cfg.num_epochs + 1)
        ):
            lr = self.cfg.lr
            if epoch >= 150:
                lr /= 10
    ...
    def robust_train(self):
        ...
        with open(
            os.path.join("outputs/07-13/04-04-42/memory_bank_net1_epoch_45.pkl"), "rb"
        ) as f:
            self.memory_bank_net1 = pickle.load(f)
        with open(
            os.path.join("outputs/07-13/04-04-42/memory_bank_net2_epoch_45.pkl"), "rb"
        ) as f:
